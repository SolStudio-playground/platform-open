...
export default function AdvancedTokenPage() {
  return (
    <PremiumGuard
      customMessage="🚀 Advanced token management features require a SolStudio Platform Pass. Unlock priority processing, exclusive tools, and premium support."
    ...
    >
      <div>
        ...
        <a href="https://solstudio.so/nft-pass" target="_blank" rel="noopener noreferrer">
          Get SolStudio Platform Pass
        </a>
      </div>
    </PremiumGuard>
  );
       ...
       <div>
         ...
         {hasNFTPass ? (
           ...
           <UpgradePrompt 
             ...
             href="https://solstudio.so/nft-pass"
           />
         )}
       </div>
     );
