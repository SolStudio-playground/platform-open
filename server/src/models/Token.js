...
const TokenSchema = new mongoose.Schema({
    ...
    mintAuthority: { type: Boolean, default: false },
    mutable: { type: Boolean, default: false },
    freezeAddress: { type: Boolean, default: false },
    tokenSupply: { type: Number, required: true },
    mintAccount: { type: String, default: null },
    freezeAccount: { type: String,  default: null },
